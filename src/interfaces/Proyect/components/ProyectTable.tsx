...
export const ProyectTable = () => {
	...
	}, [paginated, sortKey, sortDirection, columns])
	...
	const handleEdit = (project: ProjectIntakeRecordDto) => {
		openEdit(project)
	}
		...
		<>
			...
			{lastPage > 1 && (
				<div className="pagination">
					...
					<button className="pagination__button" disabled={page >= lastPage} onClick={() => setPage(page + 1)}>
						Siguiente
					</button>
				</div>
			)}
