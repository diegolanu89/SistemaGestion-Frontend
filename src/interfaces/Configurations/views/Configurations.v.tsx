...
type TabType = 'usuarios-clocky' | 'leaders' | 'calendar' | 'vacaciones' | 'usuarios'
		...
		<div className="configurations">
			<div className="configurations__header">
				<div className="configurations__header-left">
					<button
						className="configurations__back-btn"
					...
					<div className="configurations__titles">
						...
						<p className="configurations__description">
							Administración de usuarios, líderes, días laborales y vacaciones del dashboard de horas
						</p>
					</div>
				</div>
			</div>
