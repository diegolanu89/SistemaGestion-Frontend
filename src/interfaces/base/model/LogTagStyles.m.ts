...
export const LOG_TAG_STYLES: Record<LogTag, string> = {
	[LogTag.Adapter]: 'color: #ff7043; font-weight: bold',
	[LogTag.UseBiometricStatus]: 'color: #26a69a; font-weight: bold',
	[LogTag.LogFoodSearch]: 'color: #42a5f5; font-weight: bold',
	...
	// 🧩 App capabilities / feature flags
	[LogTag.Features]: 'color: #26c6da; font-weight: bold',
