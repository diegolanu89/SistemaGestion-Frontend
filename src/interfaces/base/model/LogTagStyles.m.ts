...
export const LOG_TAG_STYLES: Record<LogTag, string> = {
	...
	[LogTag.Security]: 'color:rgb(115, 0, 255); font-weight: bold',
	[LogTag.View]: 'color: #ff7043; font-weight: bold',
	[LogTag.Performance]: 'color:rgb(222, 215, 212); font-weight: bold',
}
