...
const ENV_MODE = import.meta.env.VITE_APP_MODE as AppMode | undefined

const ACTIVE_MODE: AppMode = ENV_MODE && Object.values(AppMode).includes(ENV_MODE) ? ENV_MODE : AppMode.MOCK
